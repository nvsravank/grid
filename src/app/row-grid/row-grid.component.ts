  ...
  ngOnInit(): void {
    this.options = {
      ...
      draggable: {
        ...
        start: RowGridComponent.eventStart,
        dropOverItems: false,
        dropOverItemsCallback: RowGridComponent.overlapEvent,
      },
      resizable: {
        enabled: true
      },
    ...
    this.components = [
      {cols: 4, rows: 1, y: 0, x: 0, dragEnabled: true, minItemRows: 5, minItemCols: 4, label: 'Initial Rows = 8, Initial Columns = 4\nMinimum Rows = 5, Minimum Columns = 4', delete: true, edit: true},
      {cols: 8, rows: 1, y: 0, x: 0, dragEnabled: true, minItemRows: 5, minItemCols: 8, label: 'Initial Rows = 8, Initial Columns = 8\nMinimum Rows = 5, Minimum Columns = 8', delete: true, edit: true},
      {cols: 4, rows: 1, y: 0, x: 0, dragEnabled: true, maxItemRows: 10, maxItemCols: 6, label: 'Initial Rows = 10, Initial Columns = 4\nMaximum rows = 10, Maximum Columns = 6', delete: true, edit: true},
      {cols: 2, rows: 1, y: 0, x: 0, dragEnabled: true, resizeEnabled: true, label: 'Initial Rows = 2, Initial Columns = 2\nDrag&Resize Enabled', delete: true, edit: true},
      {cols: 2, rows: 1, y: 0, x: 0, dragEnabled: false, resizeEnabled: false, label: 'Initial Rows = 2, Initial Columns = 2\nDrag&Resize Disabled', delete: true, edit: true},
      {cols: 2, rows: 1, y: 0, x: 0, dragEnabled: false, resizeEnabled: false, label: 'Initial Rows = 2, Initial Columns = 2\nDrag&Resize Disabled', delete: true, edit: true},
      {cols: 8, rows: 1, y: 0, x: 0, hasContent: true,  dragEnabled: true, resizeEnabled: true, delete: true, label: 'Graph and Table Component', type: GraphTableComponent, edit: true},
      {cols: 12, rows: 1, y: 0, x: 0, hasContent: true,  dragEnabled: true, resizeEnabled: true, delete: true, label: 'Multi Page Component', type: AccountDetailComponent, edit: true},
      {cols: 12, rows: 1, y: 0, x: 0, hasContent: true,  dragEnabled: true, resizeEnabled: true, delete: true, label: 'Multi Page Holdings Component', type: HoldingsComponent, edit: true},
      {cols: 6, rows: 1, y: 0, x: 0, hasContent: true,  dragEnabled: true, resizeEnabled: true, delete: true, label: 'Graph Component', type: GraphComponent, edit: true},
    ];
    this.dashboard = [];
    this.dashboard2 = [];
    /*
